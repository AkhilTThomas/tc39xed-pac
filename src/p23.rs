...
unsafe impl core::marker::Send for super::P23 {}
unsafe impl core::marker::Sync for super::P23 {}
impl super::P23 {
...
impl Iocr4 {
    #[doc = "Port Control for Port 23 Pin 7. This bit field defines the Port n line x functionality according to Table ."]
    #[inline(always)]
    pub fn pc4(
        self,
