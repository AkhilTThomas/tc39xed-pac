...
unsafe impl core::marker::Send for super::P21 {}
unsafe impl core::marker::Sync for super::P21 {}
impl super::P21 {
    ...
    #[doc = "Port 21 LVDS Pad Control Register 0\n resetvalue={After SSW execution:0x0E0,:0x0C0,:0x54C0,After SSW execution:0x54E0,After SSW execution:0x0E0}"]
    #[inline(always)]
...
impl Iocr4 {
    #[doc = "Port Control for Port 21 Pin 7. This bit field defines the Port n line x functionality according to Table ."]
    #[inline(always)]
    pub fn pc4(
        self,
