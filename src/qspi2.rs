...
use crate::common::*;
#[doc = r"QSPI"]
unsafe impl core::marker::Send for super::Qspi2 {}
unsafe impl core::marker::Sync for super::Qspi2 {}
impl super::Qspi2 {
    ...
    pub const fn econz(&self) -> [crate::common::Reg<self::EcoNz_SPEC, crate::common::RW>; 8] {
        unsafe {
            [
                crate::common::Reg::from_ptr(self.ptr.add(0x20usize + 0x0usize)),
                crate::common::Reg::from_ptr(self.ptr.add(0x20usize + 0x4usize)),
                crate::common::Reg::from_ptr(self.ptr.add(0x20usize + 0x8usize)),
                crate::common::Reg::from_ptr(self.ptr.add(0x20usize + 0xcusize)),
                crate::common::Reg::from_ptr(self.ptr.add(0x20usize + 0x10usize)),
                crate::common::Reg::from_ptr(self.ptr.add(0x20usize + 0x14usize)),
                crate::common::Reg::from_ptr(self.ptr.add(0x20usize + 0x18usize)),
                crate::common::Reg::from_ptr(self.ptr.add(0x20usize + 0x1cusize)),
            ]
        }
    }
    ...
    pub const fn dataentryx(
        ...
        unsafe {
            [
                crate::common::Reg::from_ptr(self.ptr.add(0x64usize + 0x0usize)),
                crate::common::Reg::from_ptr(self.ptr.add(0x64usize + 0x4usize)),
                crate::common::Reg::from_ptr(self.ptr.add(0x64usize + 0x8usize)),
                crate::common::Reg::from_ptr(self.ptr.add(0x64usize + 0xcusize)),
                crate::common::Reg::from_ptr(self.ptr.add(0x64usize + 0x10usize)),
                crate::common::Reg::from_ptr(self.ptr.add(0x64usize + 0x14usize)),
                crate::common::Reg::from_ptr(self.ptr.add(0x64usize + 0x18usize)),
                crate::common::Reg::from_ptr(self.ptr.add(0x64usize + 0x1cusize)),
            ]
        }
    }
    ...
    #[inline(always)]
    pub const fn capcon(&self) -> crate::common::Reg<self::Capcon_SPEC, crate::common::RW> {
...
impl crate::sealed::RegSpec for Capcon_SPEC {
    type DataType = u32;
}
#[doc = "Capture Control Register\n resetvalue={Application Reset:0x0}"]
pub type Capcon = crate::RegValueT<Capcon_SPEC>;

impl Capcon {
    #[doc = "Captured Value   CAP. Provides the latest capture value from the capture timer."]
    #[inline(always)]
    pub fn cap(
        self,
    ) -> crate::common::RegisterField<0, 0x7fff, 1, 0, u16, Capcon_SPEC, crate::common::R> {
        crate::common::RegisterField::<0,0x7fff,1,0,u16, Capcon_SPEC,crate::common::R>::from_register(self,0)
    }
    #[doc = "Overflow Flag   OVF. Signals if an overflow event of the capture timer occurred in the latest        measurement. Shows a value of 1 if one or more overflows of the capture        timer occurred during the latest measurement. Each capture event        refreshes this bit with the new value."]
    #[inline(always)]
    pub fn ovf(self) -> crate::common::RegisterFieldBool<15, 1, 0, Capcon_SPEC, crate::common::R> {
        crate::common::RegisterFieldBool::<15, 1, 0, Capcon_SPEC, crate::common::R>::from_register(
            self, 0,
        )
    }
    #[doc = "Edge Configuration   EDGECON. Configures the capture mode of the counter  defining which edge starts        the counting  which edge captures its contents."]
    #[inline(always)]
    pub fn edgecon(
        self,
    ) -> crate::common::RegisterField<16, 0x3, 1, 0, u8, Capcon_SPEC, crate::common::RW> {
        crate::common::RegisterField::<16,0x3,1,0,u8, Capcon_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Input Selection   INS. Selects one of four input lines for the capture signal."]
    #[inline(always)]
    pub fn ins(
        self,
    ) -> crate::common::RegisterField<18, 0x3, 1, 0, u8, Capcon_SPEC, crate::common::RW> {
        crate::common::RegisterField::<18,0x3,1,0,u8, Capcon_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Enable Bit of the Capture Timer   EN. Enables the capture timer clock. Enabled timer waits for the next start edge as defined in EDGECON         before it starts counting."]
    #[inline(always)]
    pub fn en(self) -> crate::common::RegisterFieldBool<20, 1, 0, Capcon_SPEC, crate::common::RW> {
        crate::common::RegisterFieldBool::<20, 1, 0, Capcon_SPEC, crate::common::RW>::from_register(
            self, 0,
        )
    }
    #[doc = "Capture Flag Clear   CAPC. Writing 1 to this bit clears the flag CAPF. Writing 0 has no effect.        Returns 0 on read."]
    #[inline(always)]
    pub fn capc(self) -> crate::common::RegisterFieldBool<28, 1, 0, Capcon_SPEC, crate::common::W> {
        crate::common::RegisterFieldBool::<28, 1, 0, Capcon_SPEC, crate::common::W>::from_register(
            self, 0,
        )
    }
    #[doc = "Capture Flag Set   CAPS. Writing 1 to this bit sets the flag CAPF. Writing 0 has no effect.        Returns 0 on read."]
    #[inline(always)]
    pub fn caps(self) -> crate::common::RegisterFieldBool<29, 1, 0, Capcon_SPEC, crate::common::W> {
        crate::common::RegisterFieldBool::<29, 1, 0, Capcon_SPEC, crate::common::W>::from_register(
            self, 0,
        )
    }
    #[doc = "Capture Flag   CAPF. Indicates if a capture event has occurred since the last clear event by        the bit CAPC."]
    #[inline(always)]
    pub fn capf(self) -> crate::common::RegisterFieldBool<30, 1, 0, Capcon_SPEC, crate::common::R> {
        crate::common::RegisterFieldBool::<30, 1, 0, Capcon_SPEC, crate::common::R>::from_register(
            self, 0,
        )
    }
    #[doc = "Capture Interrupt Select Bit   CAPSEL. Select if the capture events are routed to the HC interrupt line."]
    #[inline(always)]
    pub fn capsel(
        self,
    ) -> crate::common::RegisterFieldBool<31, 1, 0, Capcon_SPEC, crate::common::RW> {
        crate::common::RegisterFieldBool::<31, 1, 0, Capcon_SPEC, crate::common::RW>::from_register(
            self, 0,
        )
    }
}
impl ::core::default::Default for Capcon {
    #[inline(always)]
    fn default() -> Capcon {
        <crate::RegValueT<Capcon_SPEC> as RegisterValue<_>>::new(0)
    }
}
