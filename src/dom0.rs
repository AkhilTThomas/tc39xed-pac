...
use crate::common::*;
#[doc = r"DOM"]
unsafe impl core::marker::Send for super::Dom0 {}
unsafe impl core::marker::Sync for super::Dom0 {}
impl super::Dom0 {
    ...
    pub const fn pestat(&self) -> crate::common::Reg<self::Pestat_SPEC, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(1040usize)) }
    }

    #[doc = "Transaction ID Status Register\n resetvalue={Application Reset:0x0}"]
    #[inline(always)]
    pub const fn tidstat(&self) -> crate::common::Reg<self::Tidstat_SPEC, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(1048usize)) }
    }
    ...
    pub const fn tiden(&self) -> crate::common::Reg<self::Tiden_SPEC, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(1056usize)) }
    }
    ...
    pub const fn brcon(&self) -> crate::common::Reg<self::Brcon_SPEC, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(1072usize)) }
    }

    #[doc = "Access Enable Register 0\n resetvalue={Application Reset:0x0FFFFFFFF}"]
    #[inline(always)]
    pub const fn accen0(&self) -> crate::common::Reg<self::Accen0_SPEC, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(1264usize)) }
    }
    #[doc = "SCICTRL"]
    #[inline(always)]
    pub fn scictrl(self) -> [crate::dom0::Scictrl; 16] {
        unsafe {
            [
                crate::dom0::Scictrl {
                ...
                crate::dom0::Scictrl {
                    ptr: self.ptr.add(0x0usize + 0x120usize),
                },
                crate::dom0::Scictrl {
                    ptr: self.ptr.add(0x0usize + 0x140usize),
                },
                crate::dom0::Scictrl {
                    ptr: self.ptr.add(0x0usize + 0x160usize),
                },
                crate::dom0::Scictrl {
                    ptr: self.ptr.add(0x0usize + 0x180usize),
                },
                crate::dom0::Scictrl {
                    ptr: self.ptr.add(0x0usize + 0x1a0usize),
                },
                crate::dom0::Scictrl {
                    ptr: self.ptr.add(0x0usize + 0x1c0usize),
                },
                crate::dom0::Scictrl {
                    ptr: self.ptr.add(0x0usize + 0x1e0usize),
                },
            ]
        }
    }
