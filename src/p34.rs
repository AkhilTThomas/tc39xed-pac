...
unsafe impl core::marker::Send for super::P34 {}
unsafe impl core::marker::Sync for super::P34 {}
impl super::P34 {
...
impl Iocr4 {
    #[doc = "Port Control for Port 34 Pin 7. This bit field defines the Port n line x functionality according to Table ."]
    #[inline(always)]
    pub fn pc4(
        self,
