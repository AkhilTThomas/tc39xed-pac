...
use crate::common::*;
#[doc = r"HSSL"]
unsafe impl core::marker::Send for super::Hssl1 {}
unsafe impl core::marker::Sync for super::Hssl1 {}
impl super::Hssl1 {
    ...
    #[doc = "AW"]
    #[inline(always)]
    pub fn aw(self) -> [crate::hssl1::Aw; 4] {
        unsafe {
            [
                crate::hssl1::Aw {
