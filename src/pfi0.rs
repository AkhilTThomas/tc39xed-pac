...
use crate::common::*;
#[doc = r"PFI"]
unsafe impl core::marker::Send for super::Pfi0 {}
unsafe impl core::marker::Sync for super::Pfi0 {}
impl super::Pfi0 {
    ...
    #[doc = "SBAB"]
    #[inline(always)]
    pub fn sbab(self) -> [crate::pfi0::Sbab; 17] {
        unsafe {
            [
                crate::pfi0::Sbab {
    ...
    #[doc = "DBAB"]
    #[inline(always)]
    pub fn dbab(self) -> [crate::pfi0::Dbab; 2] {
        unsafe {
            [
                crate::pfi0::Dbab {
    ...
    #[doc = "MBAB"]
    #[inline(always)]
    pub fn mbab(self) -> crate::pfi0::Mbab {
        unsafe {
            crate::pfi0::Mbab {
    ...
    #[doc = "ZBAB"]
    #[inline(always)]
    pub fn zbab(self) -> [crate::pfi0::Zbab; 4] {
        unsafe {
            [
                crate::pfi0::Zbab {
