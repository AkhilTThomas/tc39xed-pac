...
use crate::common::*;
#[doc = r"PFI"]
unsafe impl core::marker::Send for super::Pfi4 {}
unsafe impl core::marker::Sync for super::Pfi4 {}
impl super::Pfi4 {
    ...
    #[doc = "SBAB"]
    #[inline(always)]
    pub fn sbab(self) -> [crate::pfi4::Sbab; 17] {
        unsafe {
            [
                crate::pfi4::Sbab {
    ...
    #[doc = "DBAB"]
    #[inline(always)]
    pub fn dbab(self) -> [crate::pfi4::Dbab; 2] {
        unsafe {
            [
                crate::pfi4::Dbab {
    ...
    #[doc = "MBAB"]
    #[inline(always)]
    pub fn mbab(self) -> crate::pfi4::Mbab {
        unsafe {
            crate::pfi4::Mbab {
    ...
    #[doc = "ZBAB"]
    #[inline(always)]
    pub fn zbab(self) -> [crate::pfi4::Zbab; 4] {
        unsafe {
            [
                crate::pfi4::Zbab {
