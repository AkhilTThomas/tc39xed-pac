...
unsafe impl core::marker::Send for super::Hsm {}
unsafe impl core::marker::Sync for super::Hsm {}
impl super::Hsm {
    ...
    pub const fn hsmctrl(&self) -> crate::common::Reg<self::Hsmctrl_SPEC, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(4096usize)) }
    }
}
#[doc(hidden)]
