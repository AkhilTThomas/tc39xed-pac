...
unsafe impl core::marker::Send for super::P13 {}
unsafe impl core::marker::Sync for super::P13 {}
impl super::P13 {
    ...
    #[doc = "Port 13 Input Output Control Register 4\n resetvalue={:0x0,:0x0,:0x10101010,:0x10101010}"]
    #[inline(always)]
    ...
    #[doc = "Port 13 Input Output Control Register 8\n resetvalue={:0x0,:0x0,:0x10101010,:0x10101010}"]
    #[inline(always)]
    ...
    #[doc = "Port 13 Input Output Control Register 12\n resetvalue={:0x0,:0x0,:0x10101010,:0x10101010}"]
    #[inline(always)]
    ...
    #[doc = "Port 13 Pad Driver Mode Register 1\n resetvalue={:0x0,:0x0,After SSW execution:0x22222222,After SSW execution:0x22222222}"]
    #[inline(always)]
    ...
    #[doc = "Port 13 Output Modification Set Register 4\n resetvalue={:0x0}"]
    #[inline(always)]
    ...
    #[doc = "Port 13 Output Modification Set Register 8\n resetvalue={:0x0}"]
    #[inline(always)]
    ...
    #[doc = "Port 13 Output Modification Set Register 12\n resetvalue={:0x0}"]
    #[inline(always)]
    ...
    #[doc = "Port 13 Output Modification Clear Register 4\n resetvalue={:0x0}"]
    #[inline(always)]
    ...
    #[doc = "Port 13 Output Modification Clear Register 8\n resetvalue={:0x0}"]
    #[inline(always)]
    ...
    #[doc = "Port 13 Output Modification Clear Register 12\n resetvalue={:0x0}"]
    #[inline(always)]
    ...
    #[doc = "Port 13 LVDS Pad Control Register 0\n resetvalue={After SSW execution:0x5480,:0x5480,:0x54C0,After SSW execution:0x54E0,After SSW execution:0x5480}"]
    #[inline(always)]
    pub const fn lpcr(&self) -> [crate::common::Reg<self::Lpcr_SPEC, crate::common::RW>; 8] {
        unsafe {
            [
                ...
                crate::common::Reg::from_ptr(self.ptr.add(0xa0usize + 0x8usize)),
                crate::common::Reg::from_ptr(self.ptr.add(0xa0usize + 0xcusize)),
                crate::common::Reg::from_ptr(self.ptr.add(0xa0usize + 0x10usize)),
                crate::common::Reg::from_ptr(self.ptr.add(0xa0usize + 0x14usize)),
                crate::common::Reg::from_ptr(self.ptr.add(0xa0usize + 0x18usize)),
                crate::common::Reg::from_ptr(self.ptr.add(0xa0usize + 0x1cusize)),
            ]
        }
    }
...
impl Iocr0 {
    #[doc = "Port Control for Pin 3. This bit field defines the Port n line x functionality according to Table ."]
    #[inline(always)]
    pub fn pc0(
        self,
...
impl Iocr4 {
    #[doc = "Port Control for Port 13 Pin 7. This bit field defines the Port n line x functionality according to Table ."]
    #[inline(always)]
    pub fn pc4(
        self,
...
impl Iocr8 {
    #[doc = "Port Control for Port 13 Pin 11. This bit field defines the Port n line x functionality according to Table ."]
    #[inline(always)]
    pub fn pc8(
        self,
...
impl Iocr12 {
    #[doc = "Port Control for Port 13 Pin 15. This bit field defines the Port n line x functionality according to Table ."]
    #[inline(always)]
    pub fn pc12(
        self,
