...
use crate::common::*;
#[doc = r"HSSL"]
unsafe impl core::marker::Send for super::Hssl0 {}
unsafe impl core::marker::Sync for super::Hssl0 {}
impl super::Hssl0 {
    ...
    pub fn i(self) -> [crate::hssl0::I; 4] {
        unsafe {
            [
                ...
                crate::hssl0::I {
                    ptr: self.ptr.add(0x30usize + 0x10usize),
                },
                crate::hssl0::I {
                    ptr: self.ptr.add(0x30usize + 0x20usize),
                },
                crate::hssl0::I {
                    ptr: self.ptr.add(0x30usize + 0x30usize),
                },
            ]
        }
    }
    ...
    pub fn t(self) -> [crate::hssl0::T; 4] {
        unsafe {
            [
                ...
                crate::hssl0::T {
                    ptr: self.ptr.add(0x70usize + 0x8usize),
                },
                crate::hssl0::T {
                    ptr: self.ptr.add(0x70usize + 0x10usize),
                },
                crate::hssl0::T {
                    ptr: self.ptr.add(0x70usize + 0x18usize),
                },
            ]
        }
    }
    ...
    #[doc = "TS"]
    #[inline(always)]
    pub fn ts(self) -> crate::hssl0::Ts {
        unsafe {
            crate::hssl0::Ts {
                ptr: self.ptr.add(176usize),
            }
        }
    }
    #[doc = "AW"]
    #[inline(always)]
    pub fn aw(self) -> [crate::hssl0::Aw; 4] {
        unsafe {
            [
                crate::hssl0::Aw {
