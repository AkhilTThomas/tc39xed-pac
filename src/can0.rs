...
impl super::Can0 {
    ...
    pub const fn mcr(&self) -> crate::common::Reg<self::Mcr_SPEC, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(32816usize)) }
    }
    ...
    pub const fn accenctr0(&self) -> crate::common::Reg<self::Accenctr0_SPEC, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(32988usize)) }
    }
    ...
    pub const fn ocs(&self) -> crate::common::Reg<self::Ocs_SPEC, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(33000usize)) }
    }

    #[doc = "Kernel Reset Status Clear Register\n resetvalue={Application Reset:0x0}"]
    #[inline(always)]
    pub const fn krstclr(&self) -> crate::common::Reg<self::Krstclr_SPEC, crate::common::W> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(33004usize)) }
    }

    #[doc = "Kernel Reset Register 1\n resetvalue={Application Reset:0x0}"]
    #[inline(always)]
    pub const fn krst1(&self) -> crate::common::Reg<self::Krst1_SPEC, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(33008usize)) }
    }

    #[doc = "Kernel Reset Register 0\n resetvalue={Application Reset:0x0}"]
    #[inline(always)]
    pub const fn krst0(&self) -> crate::common::Reg<self::Krst0_SPEC, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(33012usize)) }
    }

    #[doc = "Access Enable Register 0\n resetvalue={Application Reset:0x0FFFFFFFF}"]
    #[inline(always)]
    pub const fn accen0(&self) -> crate::common::Reg<self::Accen0_SPEC, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(33020usize)) }
    }
    #[doc = "N"]
    #[inline(always)]
    pub fn n(self) -> [crate::can0::N; 4] {
        unsafe {
            [
                crate::can0::N {
                    ptr: self.ptr.add(0x8100usize + 0x0usize),
                },
                crate::can0::N {
                    ptr: self.ptr.add(0x8100usize + 0x400usize),
                },
                crate::can0::N {
                    ptr: self.ptr.add(0x8100usize + 0x800usize),
                },
                crate::can0::N {
                    ptr: self.ptr.add(0x8100usize + 0xc00usize),
                },
            ]
        }
    }
...
impl N {
    ...
    #[doc = "NT"]
    #[inline(always)]
    pub fn nt(self) -> crate::can0::n::Nt {
        unsafe {
            crate::can0::n::Nt {
                ptr: self.ptr.add(32usize),
            }
        }
    }
    #[doc = "RX"]
    #[inline(always)]
    pub fn rx(self) -> crate::can0::n::Rx {
        unsafe {
            crate::can0::n::Rx {
                ptr: self.ptr.add(416usize),
            }
        }
    }
    #[doc = "TX"]
    #[inline(always)]
    pub fn tx(self) -> crate::can0::n::Tx {
        unsafe {
            crate::can0::n::Tx {
                ptr: self.ptr.add(448usize),
            }
        }
    }
    #[doc = "TT"]
    #[inline(always)]
    pub fn tt(self) -> crate::can0::n::Tt {
        unsafe {
            crate::can0::n::Tt {
                ptr: self.ptr.add(512usize),
            }
        }
    }
}
