...
use crate::common::*;
#[doc = r"INT"]
unsafe impl core::marker::Send for super::Int {}
unsafe impl core::marker::Sync for super::Int {}
impl super::Int {
    ...
    #[inline(always)]
    pub const fn srb(&self) -> [crate::common::Reg<self::Srb_SPEC, crate::common::W>; 6] {
        unsafe {
            [
    ...
    #[doc = "ACCEN"]
    #[inline(always)]
    pub fn accen(self) -> [crate::int::Accen; 6] {
        unsafe {
            [
                crate::int::Accen {
    ...
    #[doc = "ACCEN SRC"]
    #[inline(always)]
    pub fn accen_src(self) -> [crate::int::AccenSrc; 7] {
        unsafe {
            [
                crate::int::AccenSrc {
                    ptr: self.ptr.add(0x180usize + 0x0usize),
                },
                crate::int::AccenSrc {
                    ptr: self.ptr.add(0x180usize + 0x8usize),
                },
                crate::int::AccenSrc {
                    ptr: self.ptr.add(0x180usize + 0x10usize),
                },
                crate::int::AccenSrc {
                    ptr: self.ptr.add(0x180usize + 0x18usize),
                },
                crate::int::AccenSrc {
                    ptr: self.ptr.add(0x180usize + 0x20usize),
                },
                crate::int::AccenSrc {
                    ptr: self.ptr.add(0x180usize + 0x28usize),
                },
                crate::int::AccenSrc {
                    ptr: self.ptr.add(0x180usize + 0x30usize),
                },
            ]
        }
    }
    #[doc = "CH"]
    #[inline(always)]
    pub fn ch(self) -> [crate::int::Ch; 7] {
        unsafe {
            [
                crate::int::Ch {
                    ptr: self.ptr.add(0x200usize + 0x0usize),
                },
                crate::int::Ch {
                    ptr: self.ptr.add(0x200usize + 0x10usize),
                },
                crate::int::Ch {
                    ptr: self.ptr.add(0x200usize + 0x20usize),
                },
                crate::int::Ch {
                    ptr: self.ptr.add(0x200usize + 0x30usize),
                },
                crate::int::Ch {
                    ptr: self.ptr.add(0x200usize + 0x40usize),
                },
                crate::int::Ch {
                    ptr: self.ptr.add(0x200usize + 0x50usize),
                },
                crate::int::Ch {
                    ptr: self.ptr.add(0x200usize + 0x60usize),
                },
            ]
        }
    }
...
impl AccenSrc {
    ...
    pub const fn accen_src_tosx0(
        &self,
    ) -> crate::common::Reg<accensrc::AccenSrcToSx0_SPEC, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0usize)) }
    }
}
pub mod accensrc {
