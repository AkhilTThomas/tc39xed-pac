...
use crate::common::*;
#[doc = r"FCE"]
unsafe impl core::marker::Send for super::Fce {}
unsafe impl core::marker::Sync for super::Fce {}
impl super::Fce {
    ...
    #[doc = "IN"]
    #[inline(always)]
    pub fn r#in(self) -> [crate::fce::In; 8] {
        unsafe {
            [
                crate::fce::In {
                ...
                crate::fce::In {
                    ptr: self.ptr.add(0x100usize + 0x60usize),
                },
                crate::fce::In {
                    ptr: self.ptr.add(0x100usize + 0x80usize),
                },
                crate::fce::In {
                    ptr: self.ptr.add(0x100usize + 0xa0usize),
                },
                crate::fce::In {
                    ptr: self.ptr.add(0x100usize + 0xc0usize),
                },
                crate::fce::In {
                    ptr: self.ptr.add(0x100usize + 0xe0usize),
                },
            ]
        }
    }
