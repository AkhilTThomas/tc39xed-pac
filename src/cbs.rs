...
use crate::common::*;
#[doc = r"CBS"]
unsafe impl core::marker::Send for super::Cbs {}
unsafe impl core::marker::Sync for super::Cbs {}
impl super::Cbs {
    ...
    pub const fn tlccx(&self) -> [crate::common::Reg<self::TlcCx_SPEC, crate::common::RW>; 2] {
        unsafe {
            [
                crate::common::Reg::from_ptr(self.ptr.add(0x40usize + 0x0usize)),
                crate::common::Reg::from_ptr(self.ptr.add(0x40usize + 0x4usize)),
            ]
        }
    }
    ...
    #[doc = "JTAGDevice Identification Register\n resetvalue={PowerOn Reset:0x0,CFS Value:0x20205083,Application Reset:0x0,Debug Reset:0x0,IOClient Reset:0x0}"]
    #[inline(always)]
    ...
    #[doc = "TRTGB"]
    #[inline(always)]
    pub fn trtgb(self) -> [crate::cbs::Trtgb; 2] {
        unsafe {
            [
                crate::cbs::Trtgb {
                ...
                crate::cbs::Trtgb {
                    ptr: self.ptr.add(0xe0usize + 0x8usize),
                },
            ]
        }
    }
