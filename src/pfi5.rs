...
use crate::common::*;
#[doc = r"PFI"]
unsafe impl core::marker::Send for super::Pfi5 {}
unsafe impl core::marker::Sync for super::Pfi5 {}
impl super::Pfi5 {
    ...
    #[doc = "SBAB"]
    #[inline(always)]
    pub fn sbab(self) -> [crate::pfi5::Sbab; 17] {
        unsafe {
            [
                crate::pfi5::Sbab {
    ...
    #[doc = "DBAB"]
    #[inline(always)]
    pub fn dbab(self) -> [crate::pfi5::Dbab; 2] {
        unsafe {
            [
                crate::pfi5::Dbab {
    ...
    #[doc = "MBAB"]
    #[inline(always)]
    pub fn mbab(self) -> crate::pfi5::Mbab {
        unsafe {
            crate::pfi5::Mbab {
    ...
    #[doc = "ZBAB"]
    #[inline(always)]
    pub fn zbab(self) -> [crate::pfi5::Zbab; 4] {
        unsafe {
            [
                crate::pfi5::Zbab {
