...
use crate::common::*;
#[doc = r"PFI"]
unsafe impl core::marker::Send for super::Pfi2 {}
unsafe impl core::marker::Sync for super::Pfi2 {}
impl super::Pfi2 {
    ...
    #[doc = "SBAB"]
    #[inline(always)]
    pub fn sbab(self) -> [crate::pfi2::Sbab; 17] {
        unsafe {
            [
                crate::pfi2::Sbab {
    ...
    #[doc = "DBAB"]
    #[inline(always)]
    pub fn dbab(self) -> [crate::pfi2::Dbab; 2] {
        unsafe {
            [
                crate::pfi2::Dbab {
    ...
    #[doc = "MBAB"]
    #[inline(always)]
    pub fn mbab(self) -> crate::pfi2::Mbab {
        unsafe {
            crate::pfi2::Mbab {
    ...
    #[doc = "ZBAB"]
    #[inline(always)]
    pub fn zbab(self) -> [crate::pfi2::Zbab; 4] {
        unsafe {
            [
                crate::pfi2::Zbab {
