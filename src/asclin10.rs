...
use crate::common::*;
#[doc = r"ASCLIN10"]
unsafe impl core::marker::Send for super::Asclin10 {}
unsafe impl core::marker::Sync for super::Asclin10 {}
impl super::Asclin10 {
    ...
    #[doc = "LIN"]
    #[inline(always)]
    pub fn lin(self) -> crate::asclin10::Lin {
        unsafe {
            crate::asclin10::Lin {
                ptr: self.ptr.add(40usize),
            }
        }
    }
}
