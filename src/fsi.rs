...
use crate::common::*;
#[doc = r"FSI"]
unsafe impl core::marker::Send for super::Fsi {}
unsafe impl core::marker::Sync for super::Fsi {}
impl super::Fsi {
    ...
    pub const fn comm_2(&self) -> crate::common::Reg<self::Comm2_SPEC, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(5usize)) }
    }
    ...
    pub const fn hsmcomm_2(&self) -> crate::common::Reg<self::Hsmcomm2_SPEC, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(7usize)) }
    }
}
#[doc(hidden)]
