...
use crate::common::*;
#[doc = r"PFI"]
unsafe impl core::marker::Send for super::Pfi3 {}
unsafe impl core::marker::Sync for super::Pfi3 {}
impl super::Pfi3 {
    ...
    #[doc = "SBAB"]
    #[inline(always)]
    pub fn sbab(self) -> [crate::pfi3::Sbab; 17] {
        unsafe {
            [
                crate::pfi3::Sbab {
    ...
    #[doc = "DBAB"]
    #[inline(always)]
    pub fn dbab(self) -> [crate::pfi3::Dbab; 2] {
        unsafe {
            [
                crate::pfi3::Dbab {
    ...
    #[doc = "MBAB"]
    #[inline(always)]
    pub fn mbab(self) -> crate::pfi3::Mbab {
        unsafe {
            crate::pfi3::Mbab {
    ...
    #[doc = "ZBAB"]
    #[inline(always)]
    pub fn zbab(self) -> [crate::pfi3::Zbab; 4] {
        unsafe {
            [
                crate::pfi3::Zbab {
