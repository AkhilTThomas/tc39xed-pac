...
use crate::common::*;
#[doc = r"PFI"]
unsafe impl core::marker::Send for super::Pfi1 {}
unsafe impl core::marker::Sync for super::Pfi1 {}
impl super::Pfi1 {
    ...
    #[doc = "SBAB"]
    #[inline(always)]
    pub fn sbab(self) -> [crate::pfi1::Sbab; 17] {
        unsafe {
            [
                crate::pfi1::Sbab {
    ...
    #[doc = "DBAB"]
    #[inline(always)]
    pub fn dbab(self) -> [crate::pfi1::Dbab; 2] {
        unsafe {
            [
                crate::pfi1::Dbab {
                    ptr: self.ptr.add(0x4000usize + 0x0usize),
                },
                crate::pfi1::Dbab {
                    ptr: self.ptr.add(0x4000usize + 0x20usize),
                },
            ]
        }
    }
    #[doc = "MBAB"]
    #[inline(always)]
    pub fn mbab(self) -> crate::pfi1::Mbab {
        unsafe {
            crate::pfi1::Mbab {
                ptr: self.ptr.add(32768usize),
            }
        }
    }
    #[doc = "ZBAB"]
    #[inline(always)]
    pub fn zbab(self) -> [crate::pfi1::Zbab; 4] {
        unsafe {
            [
                crate::pfi1::Zbab {
